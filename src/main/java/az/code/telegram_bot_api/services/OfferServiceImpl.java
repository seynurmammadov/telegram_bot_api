...
public class OfferServiceImpl implements OfferService {
    ...
    public OfferServiceImpl(OfferRepository offerRepository, RequestService requestService, ConverterUtil converterUtil, RabbitTemplate template, MapperModel mapperModel) {
